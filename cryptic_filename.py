...
class Model:
    ...
    def generate_location(self, setting, history, requirements):
        ...
        with open("/home/workstation/work/ml/img/ComfyUI/ComfyUI-to-Python-Extension/prompt.txt", "w") as text_file:
            print(f"{out}", file=text_file)
        
        os.system('cd /home/workstation/work/ml/img/ComfyUI/ComfyUI-to-Python-Extension/  && conda run -n comfy python workflow_api.py')

        with open("/home/workstation/work/ml/img/ComfyUI/ComfyUI-to-Python-Extension/currentImage.txt", "w") as text_file:
            list_of_files = glob.glob('/home/workstation/work/ml/img/ComfyUI/output/*') # * means all if need specific format then *.csv
